...
let customData = {
  ...
  "2025-05-12": {
    hourlyActivity: [
      { name: "코딩", start: 2, end: 4 },
      { name: "수면", start: 4, end: 10 },
      { name: "코딩", start: 10, end: 14 },
      { name: "수면", start: 14, end: 15 },
      { name: "여가", start: 15, end: 16 },
      { name: "코딩", start: 16, end: 18 },
      { name: "여가", start: 18, end: 0 },
      { name: "수면", start: 0, end: 2 },
    ],
  },
  "2025-05-13": {
  ...
  "2025-05-14": {
    hourlyActivity: [
      { name: "수면", start: 2, end: 10 },
      { name: "여가", start: 10, end: 15 },
      { name: "외출", start: 15, end: 16 },
      { name: "코딩", start: 16, end: 21 },
      { name: "여가", start: 21, end: 2 },
    ],
  },
  "2025-05-15": {
    hourlyActivity: [
      { name: "수면", start: 2, end: 10 },
      { name: "여가", start: 10, end: 13 },
      { name: "코딩", start: 13, end: 21 },
      { name: "여가", start: 21, end: 1 },
      { name: "수면", start: 1, end: 2 },
    ],
  },
  "2025-05-16": {
    hourlyActivity: [
      ...
      { name: "여가", start: 10, end: 13 },
      { name: "코딩", start: 13, end: 18 },
      { name: "네트워킹", start: 18, end: 22 },
      { name: "여가", start: 22, end: 2 },
    ],
  },
};
